                        ...
                        if (isRoute) {
                            return (
                                <Link
                                    key={item.name}
                                    to={item.path}
                                    className={`flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-300 group relative overflow-hidden ${isActive
                                ...
                                >
                                    <span className={`material-icons-outlined text-xl mr-3 ${isActive ? "text-white" : "text-slate-400 group-hover:text-primary-500"}`}>{item.icon}</span>
