            ...
            <div className="container mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-8">
                    ...
                    <nav className="hidden md:flex items-center space-x-1">
                        <a className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeSection === 'hero' && !isBlogPage
                            ...
                            }`} href={isBlogPage ? "/#hero" : "#hero"}>
                            Home
                        </a>
                        <Link className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${isBlogPage
                            ? "text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20"
                            : "text-slate-600 dark:text-slate-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-slate-100 dark:hover:bg-slate-800"
                            }`} to="/blog">
                            Blog
